...
const async_engine_1 = require("./async-engine");
...
class LatencyTester {
     ...
     */
    async testGuardrailLatencyForModel(context, stageBundle, samples, iterations, desc) {
        const guardrails = await (0, runtime_1.instantiateGuardrails)(stageBundle);
        const engine = new async_engine_1.AsyncRunEngine(guardrails);
...
//# sourceMappingURL=latency-tester.js.map