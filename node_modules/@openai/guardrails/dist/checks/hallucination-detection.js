...
exports.hallucination_detection = exports.HallucinationDetectionOutput = exports.HallucinationDetectionConfig = void 0;
 ...
 */
exports.HallucinationDetectionConfig = zod_1.z.object({
 ...
 */
exports.HallucinationDetectionOutput = zod_1.z.object({
    ...
    hallucination_type: zod_1.z.string().nullable(),
    /** Specific statements flagged as potentially hallucinated */
    hallucinated_statements: zod_1.z.array(zod_1.z.string()).nullable(),
    /** Specific statements that are supported by the documents */
    verified_statements: zod_1.z.array(zod_1.z.string()).nullable(),
});
/**
 ...
 */
const hallucination_detection = async (ctx, candidate, config) => {
    ...
    try {
        ...
        try {
            ...
            return (0, llm_base_1.createErrorResult)('Hallucination Detection', errorOutput, {
        ...
        const analysis = exports.HallucinationDetectionOutput.parse(parsedJson);
...
exports.hallucination_detection = hallucination_detection;
// Register the guardrail
registry_1.defaultSpecRegistry.register('Hallucination Detection', exports.hallucination_detection, 'Detects potential hallucinations in AI-generated text using OpenAI Responses API with file search. Validates claims against actual documents and flags factually incorrect, unsupported, or potentially fabricated information.', 'text/plain', exports.HallucinationDetectionConfig, undefined, { engine: 'FileSearch' });
