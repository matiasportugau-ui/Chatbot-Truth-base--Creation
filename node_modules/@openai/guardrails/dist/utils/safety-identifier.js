...
exports.SAFETY_IDENTIFIER = void 0;
exports.supportsSafetyIdentifier = supportsSafetyIdentifier;
/**
 * OpenAI safety identifier for tracking guardrails library usage.
 */
exports.SAFETY_IDENTIFIER = 'openai-guardrails-js';
/**
 ...
 * ```
 */
function supportsSafetyIdentifier(client) {
    ...
    const baseURL = clientObj.baseURL ??
        clientObj._client?.baseURL ??
        clientObj._baseURL;
