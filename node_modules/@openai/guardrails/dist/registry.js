...
exports.defaultSpecRegistry = exports.GuardrailRegistry = void 0;
 ...
 */
const NO_CONFIG = zod_1.z.object({});
/**
 ...
 */
const NO_CONTEXT_REQUIREMENTS = zod_1.z.object({});
/**
...
class GuardrailRegistry {
    ...
    register(name, checkFn, description, mediaType = 'text/plain', configSchema, ctxRequirements, metadata) {
        const config = configSchema || NO_CONFIG;
        const context = ctxRequirements || NO_CONTEXT_REQUIREMENTS;
        const spec = new spec_1.GuardrailSpec(name, description, mediaType, config, checkFn, context, metadata);
...
exports.GuardrailRegistry = GuardrailRegistry;
/**
 ...
 */
exports.defaultSpecRegistry = new GuardrailRegistry();
