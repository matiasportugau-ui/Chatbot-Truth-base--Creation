...
class CheckpointManager:
    ...
    def __init__(
        ...
        Args:
            ...
            auto_cleanup_days: Auto-cleanup checkpoints older than N days (default: 30)
        """
    ...
    def save_checkpoint(
        ...
        checkpoint_metadata = {
            ...
            "time_trigger": (datetime.now() - self.last_checkpoint_time) >= self.time_interval if self.last_checkpoint_time else False,
            **(metadata or {})
        }
    ...
    def get_session_history(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        checkpoints = self.db.get_checkpoints_for_session(self.current_session_id, limit)
