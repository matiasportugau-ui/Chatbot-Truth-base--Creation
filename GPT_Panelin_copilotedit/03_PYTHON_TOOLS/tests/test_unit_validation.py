...
NOTE: These tests inject mock_bom_rules into validate_autoportancia()
to avoid loading real BOM rules from disk.
"""
...
class TestAutoportanciaValidation:
    ...
    def test_safety_margin_calculation(self, mock_bom_rules):
        ...
        result = validate_autoportancia(
            "ISODEC_EPS", 100, 5.0, safety_margin=0.15, bom_rules=mock_bom_rules
        )
    ...
    def test_custom_safety_margin(self, mock_bom_rules):
        ...
        result = validate_autoportancia(
            "ISODEC_EPS", 100, 4.5, safety_margin=0.20, bom_rules=mock_bom_rules
        )
...
class TestAutoportanciaParameterized:
    ...
    def test_validation_result(self, family, thickness, span, expected_valid, mock_bom_rules):
